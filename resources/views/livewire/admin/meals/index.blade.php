<div wire:poll.alive.5s>
        ...
        <article class="section_page">
            ...
            <div class="container_cards active" wire:ignore.self>
                ...
                @else
                    <div class="header_primary p_sticky">
                        <div class="flex_start_center gap_05">
                            <div class="flex_start_center">
                                ...
                                <div class="text text_secoundary grey_text">
                                    {{($this->meals->currentPage() - 1) * $this->meals->perPage() + 1}} 
                                    for 
                                    {{min($this->meals->currentPage()*$this->meals->perPage(),$this->meals->total())}}
                                    of 
                                    {{$this->meals->total()}}
                                </div>
                            </div>
                        ...
                        <div class="flex_start_center gap_05">
                            <div class="flex_start_center text_click">
                                <svg class="svg_fill" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5 2C3.34315 2 2 3.34315 2 5V19C2 20.6569 3.34315 22 5 22H19C20.6569 22 22 20.6569 22 19V5C22 3.34315 20.6569 2 19 2H5ZM14 4H10V8H14V4ZM16 4V8H20V5C20 4.44771 19.5523 4 19 4H16ZM14 10H10V14H14V10ZM16 14V10H20V14H16ZM14 16H10V20H14V16ZM16 20V16H20V19C20 19.5523 19.5523 20 19 20H16ZM5 4H8V8H4V5C4 4.44772 4.44771 4 5 4ZM4 10H8V14H4V10ZM4 16H8V20H5C4.44772 20 4 19.5523 4 19V16Z" fill=""/>
                                </svg>
                            </div>
                            <div class="slash"></div>
                            @if ($selection)
                ...
                <article class="container_primary">
                    ...
                    <div class="cards_flex cards_block">
                                        ...
                                        <div class="flex_between_center">
                                            <div class="flex_start_center gap_1">
                                                <div class="text text_secoundary">
                                                    {{Str::limit($meal->name, 13)}}
                                                </div>
                                                {!!helpHelper::status($meal->status)!!}
                                            </div>
                                        ...
                                        <div class="flex_between_center mt_05">
                                            <div class="details_card">
                                                <div class="flex_start_center gap_05">
                                                    ...
                                                    <div class="text text_small clamp_1">{{Str::limit($meal->category->name,6)}}</div>
                                                </div> 
                                                <div class="slash"></div> 
                                                <div class="flex_start_center gap_05">
                                                    ...
                                                    <div class="text text_small clamp_1">{{$meal->price_achat*0.3}}K</div>
                                                </div> 
                                                <div class="slash"></div> 
                                                <div class="flex_start_center gap_05">
                                                    ...
                                                    <div class="text text_small clamp_1">{{$meal->price_achat}}K</div>
                                                </div>        
                                            </div>
                                            <div class="flex_start_center actions_card">
                                                <button type="button" class="action text text_small" wire:click.stop='edit("{{$meal->id}}")'>
                                                ...
                                                <button type="button" class="action text text_small" wire:click.stop='deleteThis("{{$meal->id}}")'>
                    ...
                    {{ $this->meals->links('components.min.paginate') }} 
    ...
    @endif 
    @if ($boxfilter)
        @component('widgets.articles.filterUseCategory', ["collection"=>$this->categories])@endcomponent
    @endif 
