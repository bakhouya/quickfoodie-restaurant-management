    ...
    <div class="body_filter scroll">
        ...
        <div class="item_filter_box">
            ...
            <div class="body_item_filter grid_1 gap_secoundary" wire:ignore.self>
                <button type=button class="flex_between_center item_body_filter" wire:click='getfilterUseCategory'>
                    <div class="text text_secoundary grey_text">select le category</div>
                </button>
            </div>
        </div>
    </div>
